...
#include <KOptionControl.h>

#include <cstring>


/*! \brief Creates and initializes a KOptionControl.
...
*/
KOptionControl::KOptionControl(BRect frame, const char *name, const char *label,
								BMessage *message, uint32 resize, uint32 flags)
	:
	KControl(frame, name, label, message, resize, flags)
{
}


KOptionControl::KOptionControl(const char *name, const char *label,
...
*/
void
KOptionControl::MessageReceived(BMessage *message)
{
	switch (message->what) {
...
*/
status_t
KOptionControl::AddOption(const char *name, int32 value)
{
...
*/
status_t
KOptionControl::SelectOptionFor(int32 value)
{
...
*/
status_t
KOptionControl::SelectOptionFor(const char *name)
{
	int32 numOptions = CountOptions();
	for (int32 c = 0; c < numOptions; c++) {
...
*/
BMessage *
KOptionControl::MakeValueMessage(int32 value)
{
...
KOptionControl::KOptionControl()
	:
	KControl(BRect(), "", "", NULL, 0, 0)
{
}


KOptionControl::KOptionControl(const KOptionControl & clone)
	:
	KControl(BRect(), "", "", NULL, 0, 0)
{
}
...
KOptionControl &
KOptionControl::operator=(const KOptionControl & clone)
{
	return *this;
}
...
// FBC
status_t KOptionControl::_Reserved_OptionControl_0(void *, ...) { return B_ERROR; }
status_t KOptionControl::_Reserved_OptionControl_1(void *, ...) { return B_ERROR; }
status_t KOptionControl::_Reserved_OptionControl_2(void *, ...) { return B_ERROR; }
status_t KOptionControl::_Reserved_OptionControl_3(void *, ...) { return B_ERROR; }
status_t KOptionControl::_Reserved_OptionControl_4(void *, ...) { return B_ERROR; }
status_t KOptionControl::_Reserved_OptionControl_5(void *, ...) { return B_ERROR; }
status_t KOptionControl::_Reserved_OptionControl_6(void *, ...) { return B_ERROR; }
status_t KOptionControl::_Reserved_OptionControl_7(void *, ...) { return B_ERROR; }
status_t KOptionControl::_Reserved_OptionControl_8(void *, ...) { return B_ERROR; }
status_t KOptionControl::_Reserved_OptionControl_9(void *, ...) { return B_ERROR; }
status_t KOptionControl::_Reserved_OptionControl_10(void *, ...) { return B_ERROR; }
status_t KOptionControl::_Reserved_OptionControl_11(void *, ...) { return B_ERROR; }
