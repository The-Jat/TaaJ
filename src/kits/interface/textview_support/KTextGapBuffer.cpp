...
void
KTextGapBuffer::InsertText(const char* inText, int32 inNumItems, int32 inAtIndex)
{
	if (inNumItems < 1)
		return;
...
bool
KTextGapBuffer::InsertText(BFile* file, int32 fileOffset, int32 inNumItems,
	int32 inAtIndex)
{
	off_t fileSize;
...
void
KTextGapBuffer::RemoveRange(int32 start, int32 end)
{
...
const char*
KTextGapBuffer::GetString(int32 fromOffset, int32* _numBytes)
{
	const char* result = "";
	if (_numBytes == NULL)
		return result;
...
bool
KTextGapBuffer::FindChar(char inChar, int32 fromIndex, int32* ioDelta)
{
...
void
KTextGapBuffer::GetString(int32 offset, int32 length, char* buffer)
{
	if (buffer == NULL)
		return;
...
bool
KTextGapBuffer::PasswordMode() const
{
...
void
KTextGapBuffer::SetPasswordMode(bool state)
{
	fPasswordMode = state;
}
...
void
KTextGapBuffer::_MoveGapTo(int32 toIndex)
{
...
void
KTextGapBuffer::_EnlargeGapTo(int32 inCount)
{
...
void
KTextGapBuffer::_ShrinkGapTo(int32 inCount)
{
	if (inCount == fGapCount)
		return;
