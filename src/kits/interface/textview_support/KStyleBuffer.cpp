...
/**	Style storage used by KTextView */
...
//	#pragma mark - _KStyleRunDescBuffer_


_KStyleRunDescBuffer_::_KStyleRunDescBuffer_()
	:
...
void
_KStyleRunDescBuffer_::InsertDesc(STEStyleRunDesc* inDesc, int32 index)
{
...
void
_KStyleRunDescBuffer_::RemoveDescs(int32 index, int32 count)
{
...
int32
_KStyleRunDescBuffer_::OffsetToRun(int32 offset) const
{
	if (fItemCount <= 1)
		return 0;
...
void
_KStyleRunDescBuffer_::BumpOffset(int32 delta, int32 index)
{
...
//	#pragma mark - _KStyleRecordBuffer_


_KStyleRecordBuffer_::_KStyleRecordBuffer_()
	:
	_BTextViewSupportBuffer_<KSTEStyleRecord>()
{
}


int32
_KStyleRecordBuffer_::InsertRecord(const BFont* inFont,
	const rgb_color* inColor)
{
	...
	const KSTEStyle style = { *inFont, *inColor };
	const KSTEStyleRecord newRecord = {
		0,
		fh.ascent,
...
void
_KStyleRecordBuffer_::CommitRecord(int32 index)
{
	fBuffer[index].refs++;
}
...
void
_KStyleRecordBuffer_::RemoveRecord(int32 index)
{
	fBuffer[index].refs--;
}
...
bool
_KStyleRecordBuffer_::MatchRecord(const BFont* inFont, const rgb_color* inColor,
	int32* outIndex)
{
...
//	#pragma mark - KTextView::StyleBuffer


KTextView::StyleBuffer::StyleBuffer(const BFont* inFont,
	const rgb_color* inColor)
	:
...
void
KTextView::StyleBuffer::InvalidateNullStyle()
{
...
bool
KTextView::StyleBuffer::IsValidNullStyle() const
{
...
void
KTextView::StyleBuffer::SyncNullStyle(int32 offset)
{
...
void
KTextView::StyleBuffer::SetNullStyle(uint32 inMode, const BFont* inFont,
...
void
KTextView::StyleBuffer::GetNullStyle(const BFont** font,
...
KSTEStyleRange*
KTextView::StyleBuffer::AllocateStyleRange(const int32 numStyles) const
{
	KSTEStyleRange* range = (KSTEStyleRange*)malloc(sizeof(int32)
		+ sizeof(KSTEStyleRun) * numStyles);
	if (range != NULL)
...
void
KTextView::StyleBuffer::SetStyleRange(int32 fromOffset, int32 toOffset,
	...
	const rgb_color* inColor)
{
	...
	do {
		...
		KSTEStyle style = fStyleRecord[runDesc.index]->style;
...
void
KTextView::StyleBuffer::GetStyle(int32 inOffset, BFont* outFont,
...
KSTEStyleRange*
KTextView::StyleBuffer::GetStyleRange(int32 startOffset, int32 endOffset) const
{
	...
	KSTEStyleRange* result = AllocateStyleRange(numStyles);
	if (result == NULL)
		return NULL;

	KSTEStyleRun* run = &result->runs[0];
...
void
KTextView::StyleBuffer::RemoveStyleRange(int32 fromOffset, int32 toOffset)
{
...
void
KTextView::StyleBuffer::RemoveStyles(int32 index, int32 count)
{
...
int32
KTextView::StyleBuffer::Iterate(int32 fromOffset, int32 length,
	InlineInput* input,
...
int32
KTextView::StyleBuffer::OffsetToRun(int32 offset) const
{
...
void
KTextView::StyleBuffer::BumpOffset(int32 delta, int32 index)
{
...
KSTEStyleRun
KTextView::StyleBuffer::operator[](int32 index) const
{
	KSTEStyleRun run;
...
// ? FilterStyles ?
static void
FixupMode(const KSTEStyle &firstStyle, const KSTEStyle &otherStyle, uint32 &mode,
	bool &sameColor)
{
	if ((mode & B_FONT_FAMILY_AND_STYLE) != 0) {
...
void
KTextView::StyleBuffer::ContinuousGetStyle(BFont *outFont, uint32* ioMode,
	...
	int32 toOffset) const
{
	...
	if (fromIndex == toIndex) {
		...
		const KSTEStyle* style = &fStyleRecord[styleIndex]->style;
		...
		KSTEStyle theStyle = fStyleRecord[styleIndex]->style;
