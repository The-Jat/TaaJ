...
KWindowStack::KWindowStack(KWindow* window)
{
	fLink = window->fLink;
}


KWindowStack::~KWindowStack()
{
...
status_t
KWindowStack::AddWindow(const KWindow* window)
{
...
status_t
KWindowStack::AddWindow(const BMessenger& window)
{
...
status_t
KWindowStack::AddWindowAt(const KWindow* window, int32 position)
{
	BMessenger messenger(window);
...
status_t
KWindowStack::AddWindowAt(const BMessenger& window, int32 position)
{
...
status_t
KWindowStack::RemoveWindow(const KWindow* window)
{
	BMessenger messenger(window);
...
status_t
KWindowStack::RemoveWindow(const BMessenger& window)
{
...
status_t
KWindowStack::RemoveWindowAt(int32 position, BMessenger* window)
{
...
status_t
KWindowStack::WindowAt(int32 position, BMessenger& messenger)
{
...
bool
KWindowStack::HasWindow(const KWindow* window)
{
	BMessenger messenger(window);
...
bool
KWindowStack::HasWindow(const BMessenger& window)
{
...
status_t
KWindowStack::_AttachMessenger(const BMessenger& window)
{
...
status_t
KWindowStack::_ReadMessenger(BMessenger& window)
{
	port_id port;
	int32 token;
	team_id team;
...
status_t
KWindowStack::_StartMessage(int32 what)
{
