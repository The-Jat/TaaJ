...
// // AddSizesFloat
// float
// KLayoutUtils::AddSizesFloat(float a, float b)
// {
// 	float sum = a + b + 1;
...
// // AddSizesFloat
// float
// KLayoutUtils::AddSizesFloat(float a, float b, float c)
// {
...
// AddSizesInt32
int32
KLayoutUtils::AddSizesInt32(int32 a, int32 b)
{
...
// AddSizesInt32
int32
KLayoutUtils::AddSizesInt32(int32 a, int32 b, int32 c)
{
...
// AddDistances
float
KLayoutUtils::AddDistances(float a, float b)
{
	float sum = a + b + 1;
	if (sum >= B_SIZE_UNLIMITED)
		return B_SIZE_UNLIMITED;
...
// AddDistances
float
KLayoutUtils::AddDistances(float a, float b, float c)
{
...
// // SubtractSizesFloat
// float
// KLayoutUtils::SubtractSizesFloat(float a, float b)
// {
// 	if (a < b)
// 		return -1;
// 	return a - b - 1;
...
// SubtractSizesInt32
int32
KLayoutUtils::SubtractSizesInt32(int32 a, int32 b)
{
	if (a < b)
		return 0;
	return a - b;
...
// SubtractDistances
float
KLayoutUtils::SubtractDistances(float a, float b)
{
	if (a < b)
		return -1;
	return a - b - 1;
...
// FixSizeConstraints
void
KLayoutUtils::FixSizeConstraints(float& min, float& max, float& preferred)
{
	if (max < min)
		max = min;
	if (preferred < min)
...
// FixSizeConstraints
void
KLayoutUtils::FixSizeConstraints(BSize& min, BSize& max, BSize& preferred)
{
...
// ComposeSize
BSize
KLayoutUtils::ComposeSize(BSize size, BSize layoutSize)
{
	if (!size.IsWidthSet())
...
// ComposeAlignment
BAlignment
KLayoutUtils::ComposeAlignment(BAlignment alignment, BAlignment layoutAlignment)
{
...
BRect
KLayoutUtils::AlignInFrame(BRect frame, BSize maxSize, BAlignment alignment)
{
...
// AlignInFrame
void
KLayoutUtils::AlignInFrame(KView* view, BRect frame)
{
...
BRect
KLayoutUtils::AlignOnRect(BRect rect, BSize size, BAlignment alignment)
{
...
*/
/*static*/ BRect
KLayoutUtils::MoveIntoFrame(BRect rect, BSize frameSize)
{
...
/*static*/ BString
KLayoutUtils::GetLayoutTreeDump(KView* view)
{
	BString result;
...
/*static*/ BString
KLayoutUtils::GetLayoutTreeDump(KLayoutItem* item)
{
	BString result;
...
/*static*/ void
KLayoutUtils::_GetLayoutTreeDump(KView* view, int level, BString& _output)
{
	BString indent;
	...
	if (KLayout* layout = view->GetLayout()) {
...
/*static*/ void
KLayoutUtils::_GetLayoutTreeDump(KLayoutItem* item, int level,
	bool isViewLayout, BString& _output)
{
	if (KViewLayoutItem* viewItem = dynamic_cast<KViewLayoutItem*>(item)) {
	...
	KLayout* layout = dynamic_cast<KLayout*>(item);
