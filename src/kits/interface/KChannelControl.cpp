...
KChannelControl::KChannelControl(BRect frame, const char* name,
	const char* label, BMessage* model, int32 channel_count,
	uint32 resizingMode, uint32 flags)
	:
	KControl(frame, name, label, model, resizingMode, flags),
...
KChannelControl::KChannelControl(const char* name, const char* label,
	BMessage* model, int32 channelCount, uint32 flags)
	:
	KControl(name, label, model, flags),
...
KChannelControl::KChannelControl(BMessage* archive)
	:
	KControl(archive),
	fChannelCount(0),
	fCurrentChannel(0),
...
KChannelControl::~KChannelControl()
{
	delete[] fChannelMin;
	delete[] fChannelMax;
...
status_t
KChannelControl::Archive(BMessage* data, bool deep) const
{
...
void
KChannelControl::FrameResized(float newWidth, float newHeight)
{
...
void
KChannelControl::SetFont(const BFont* font, uint32 mask)
{
...
void
KChannelControl::ResizeToPreferred()
{
...
void
KChannelControl::MessageReceived(BMessage* message)
{
...
BHandler*
KChannelControl::ResolveSpecifier(BMessage* message, int32 index,
	BMessage* specifier, int32 what, const char* property)
{
	...
	if (propertyInfo.FindMatch(message, index, specifier, what, property)
			< B_OK) {
		target = KControl::ResolveSpecifier(message, index, specifier,
			what, property);
	}
...
status_t
KChannelControl::GetSupportedSuites(BMessage* data)
{
	if (data == NULL)
		return B_BAD_VALUE;
...
void
KChannelControl::SetModificationMessage(BMessage* message)
{
	delete fModificationMsg;
...
BMessage*
KChannelControl::ModificationMessage() const
{
...
status_t
KChannelControl::Invoke(BMessage* message)
{
	bool notify = false;
	...
	return KControl::Invoke(&invokeMessage);
}


status_t
KChannelControl::InvokeChannel(BMessage* message, int32 fromChannel,
...
status_t
KChannelControl::InvokeNotifyChannel(BMessage* message, uint32 kind,
...
void
KChannelControl::SetValue(int32 value)
{
	// Get real
...
status_t
KChannelControl::SetCurrentChannel(int32 channel)
{
	...
	if (channel != fCurrentChannel) {
		...
		KControl::SetValue(fChannelValues[fCurrentChannel]);
	}
...
int32
KChannelControl::CurrentChannel() const
{
...
int32
KChannelControl::CountChannels() const
{
...
status_t
KChannelControl::SetChannelCount(int32 channel_count)
{
...
int32
KChannelControl::ValueFor(int32 channel) const
{
	int32 value = 0;
...
int32
KChannelControl::GetValue(int32* outValues, int32 fromChannel,
...
status_t
KChannelControl::SetValueFor(int32 channel, int32 value)
{
...
status_t
KChannelControl::SetValue(int32 fromChannel, int32 channelCount,
	const int32* values)
{
...
status_t
KChannelControl::SetAllValue(int32 values)
{
...
status_t
KChannelControl::SetLimitsFor(int32 channel, int32 minimum, int32 maximum)
{
...
status_t
KChannelControl::GetLimitsFor(int32 channel, int32* minimum,
	int32* maximum) const
{
...
status_t
KChannelControl::SetLimitsFor(int32 fromChannel, int32 channelCount,
...
status_t
KChannelControl::GetLimitsFor(int32 fromChannel, int32 channelCount,
...
status_t
KChannelControl::SetLimits(int32 minimum, int32 maximum)
{
	if (minimum > maximum)
		return B_BAD_VALUE;
...
status_t
KChannelControl::GetLimits(int32* outMinimum, int32* outMaximum) const
{
...
status_t
KChannelControl::SetLimitLabels(const char* minLabel, const char* maxLabel)
{
...
const char*
KChannelControl::MinLimitLabel() const
{
...
const char*
KChannelControl::MaxLimitLabel() const
{
...
status_t
KChannelControl::SetLimitLabelsFor(int32 channel, const char* minLabel,
	const char* maxLabel)
{
...
status_t
KChannelControl::SetLimitLabelsFor(int32 fromChannel, int32 channelCount,
...
const char*
KChannelControl::MinLimitLabelFor(int32 channel) const
{
...
const char*
KChannelControl::MaxLimitLabelFor(int32 channel) const
{
	if (fMultiLabels != NULL) {
		label_map::const_iterator iter = ((label_map*)fMultiLabels)->find(channel);
		if (iter != ((label_map*)fMultiLabels)->end())
...
status_t
KChannelControl::StuffValues(int32 fromChannel, int32 channelCount,
	const int32* values)
{
	if (values == NULL)
		return B_BAD_VALUE;
...
void KChannelControl::_Reserverd_ChannelControl_0(void*, ...) {}
void KChannelControl::_Reserverd_ChannelControl_1(void*, ...) {}
void KChannelControl::_Reserverd_ChannelControl_2(void*, ...) {}
void KChannelControl::_Reserverd_ChannelControl_3(void*, ...) {}
void KChannelControl::_Reserverd_ChannelControl_4(void*, ...) {}
void KChannelControl::_Reserverd_ChannelControl_5(void*, ...) {}
void KChannelControl::_Reserverd_ChannelControl_6(void*, ...) {}
void KChannelControl::_Reserverd_ChannelControl_7(void*, ...) {}
void KChannelControl::_Reserverd_ChannelControl_8(void*, ...) {}
void KChannelControl::_Reserverd_ChannelControl_9(void*, ...) {}
void KChannelControl::_Reserverd_ChannelControl_10(void*, ...) {}
void KChannelControl::_Reserverd_ChannelControl_11(void*, ...) {}
