...
KSeparatorView::KSeparatorView(orientation orientation, border_style border)
	:
	KView(NULL, B_WILL_DRAW | B_FULL_UPDATE_ON_RESIZE)
{
...
KSeparatorView::KSeparatorView(const char* name, const char* label,
	orientation orientation, border_style border, const BAlignment& alignment)
	:
	KView(name, B_WILL_DRAW | B_FULL_UPDATE_ON_RESIZE)
{
	_Init(label, NULL, orientation, alignment, border);
}


KSeparatorView::KSeparatorView(const char* name, KView* labelView,
	orientation orientation, border_style border, const BAlignment& alignment)
	:
	KView(name, B_WILL_DRAW | B_FULL_UPDATE_ON_RESIZE)
{
...
KSeparatorView::KSeparatorView(const char* label,
	orientation orientation, border_style border, const BAlignment& alignment)
	:
	KView("", B_WILL_DRAW | B_FULL_UPDATE_ON_RESIZE)
{
	_Init(label, NULL, orientation, alignment, border);
}


KSeparatorView::KSeparatorView(KView* labelView,
	orientation orientation, border_style border, const BAlignment& alignment)
	:
	KView("", B_WILL_DRAW | B_FULL_UPDATE_ON_RESIZE)
{
...
KSeparatorView::KSeparatorView(BMessage* archive)
	:
	KView(archive),
	fLabel(),
	fLabelView(NULL),
...
{
	// NULL archives will be caught by KView.
...
BArchivable*
KSeparatorView::Instantiate(BMessage* archive)
{
	if (validate_instantiation(archive, "KSeparatorView"))
		return new (std::nothrow) KSeparatorView(archive);
...
status_t
KSeparatorView::Archive(BMessage* into, bool deep) const
{
	// TODO: Test this.
	status_t result = KView::Archive(into, deep);
	if (result != B_OK)
		return result;
...
void
KSeparatorView::Draw(BRect updateRect)
{
	rgb_color bgColor = ui_color(B_PANEL_BACKGROUND_COLOR);
	rgb_color highColor = ui_color(B_PANEL_TEXT_COLOR);

	if (KView* parent = Parent()) {
	...
	if (borderSize > 0.0f) {
		if (fOrientation == B_HORIZONTAL) {
			...
			k_be_control_look->DrawBorder(this, bounds, updateRect, bgColor,
				fBorder, 0, KControlLook::B_TOP_BORDER);
		} else {
			...
			region.Exclude(bounds);
			k_be_control_look->DrawBorder(this, bounds, updateRect, bgColor,
				fBorder, 0, KControlLook::B_LEFT_BORDER);
		}
		if (labelBounds.IsValid())
...
void
KSeparatorView::GetPreferredSize(float* _width, float* _height)
{
	float width = 0.0f;
	float height = 0.0f;
...
void
KSeparatorView::SetOrientation(orientation orientation)
{
...
void
KSeparatorView::SetAlignment(const BAlignment& aligment)
{
...
void
KSeparatorView::SetBorderStyle(border_style border)
{
	if (border == fBorder)
		return;
...
void
KSeparatorView::SetLabel(const char* label)
{
	if (label == NULL)
		label = "";
...
void
KSeparatorView::SetLabel(KView* view, bool deletePrevious)
{
	if (fLabelView == view)
		return;
...
status_t
KSeparatorView::Perform(perform_code code, void* data)
{
	return KView::Perform(code, data);
}
...
KSeparatorView::DoLayout()
{
	...
	BRect frame = KLayoutUtils::AlignInFrame(bounds, fLabelView->MaxSize(),
		fAlignment);
...
void
KSeparatorView::_Init(const char* label, KView* labelView,
...
float
KSeparatorView::_BorderSize() const
{
	// TODO: Get these values from the KControlLook class.
	switch (fBorder) {
		case B_PLAIN_BORDER:
			return 1.0f;
...
BRect
KSeparatorView::_MaxLabelBounds() const
{
	BRect bounds = Bounds();
	if (fOrientation == B_HORIZONTAL)
...
void KSeparatorView::_ReservedSeparatorView1() {}
void KSeparatorView::_ReservedSeparatorView2() {}
void KSeparatorView::_ReservedSeparatorView3() {}
void KSeparatorView::_ReservedSeparatorView4() {}
void KSeparatorView::_ReservedSeparatorView5() {}
void KSeparatorView::_ReservedSeparatorView6() {}
void KSeparatorView::_ReservedSeparatorView7() {}
void KSeparatorView::_ReservedSeparatorView8() {}
void KSeparatorView::_ReservedSeparatorView9() {}
void KSeparatorView::_ReservedSeparatorView10() {}
