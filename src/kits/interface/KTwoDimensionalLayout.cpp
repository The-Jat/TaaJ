...
// CompoundLayouter
class KTwoDimensionalLayout::CompoundLayouter : public BReferenceable {
public:
...
class KTwoDimensionalLayout::VerticalCompoundLayouter
...
// LocalLayouter
class KTwoDimensionalLayout::LocalLayouter : private BLayoutContextListener {
public:
								LocalLayouter(KTwoDimensionalLayout* layout);
								~LocalLayouter();

	// interface for the KTwoDimensionalLayout class
...
// archiving constants
namespace {
	const char* const kHAlignedLayoutField = "KTwoDimensionalLayout:"
		"halignedlayout";
	const char* const kVAlignedLayoutField = "KTwoDimensionalLayout:"
		"valignedlayout";
	const char* const kInsetsField = "KTwoDimensionalLayout:insets";
	const char* const kSpacingField = "KTwoDimensionalLayout:spacing";
		// kSpacingField = {fHSpacing, fVSpacing}
}


KTwoDimensionalLayout::KTwoDimensionalLayout()
	:
	fLeftInset(0),
	fRightInset(0),
	fTopInset(0),
...
KTwoDimensionalLayout::KTwoDimensionalLayout(BMessage* from)
	:
	KAbstractLayout(from),
	fLeftInset(0),
	fRightInset(0),
	fTopInset(0),
	fBottomInset(0),
...
void
KTwoDimensionalLayout::SetInsets(float left, float top, float right,
	float bottom)
{
	fLeftInset = KControlLook::ComposeSpacing(left);
	fTopInset = KControlLook::ComposeSpacing(top);
	fRightInset = KControlLook::ComposeSpacing(right);
	fBottomInset = KControlLook::ComposeSpacing(bottom);
...
void
KTwoDimensionalLayout::SetInsets(float horizontal, float vertical)
{
	fLeftInset = KControlLook::ComposeSpacing(horizontal);
	fRightInset = fLeftInset;

	fTopInset = KControlLook::ComposeSpacing(vertical);
...
void
KTwoDimensionalLayout::SetInsets(float insets)
{
	fLeftInset = KControlLook::ComposeSpacing(insets);
	fRightInset = fLeftInset;
...
void
KTwoDimensionalLayout::GetInsets(float* left, float* top, float* right,
	float* bottom) const
{
	if (left)
		*left = fLeftInset;
...
void
KTwoDimensionalLayout::AlignLayoutWith(KTwoDimensionalLayout* other,
	orientation orientation)
{
	if (!other || other == this)
		return;
...
BSize
KTwoDimensionalLayout::BaseMinSize()
{
	_ValidateMinMax();
...
BSize
KTwoDimensionalLayout::BaseMaxSize()
{
	_ValidateMinMax();
...
BSize
KTwoDimensionalLayout::BasePreferredSize()
{
	_ValidateMinMax();
...
BAlignment
KTwoDimensionalLayout::BaseAlignment()
{
...
bool
KTwoDimensionalLayout::HasHeightForWidth()
{
	_ValidateMinMax();
...
void
KTwoDimensionalLayout::GetHeightForWidth(float width, float* min, float* max,
	float* preferred)
{
...
void
KTwoDimensionalLayout::SetFrame(BRect frame)
{
	KAbstractLayout::SetFrame(frame);
}


status_t
KTwoDimensionalLayout::Archive(BMessage* into, bool deep) const
{
...
status_t
KTwoDimensionalLayout::AllArchived(BMessage* into) const
{
	BArchiver archiver(into);

	status_t err = KLayout::AllArchived(into);
	if (err == B_OK)
...
status_t
KTwoDimensionalLayout::AllUnarchived(const BMessage* from)
{
...
status_t
KTwoDimensionalLayout::ItemArchived(BMessage* into, KLayoutItem* item,
	int32 index) const
{
...
status_t
KTwoDimensionalLayout::ItemUnarchived(const BMessage* from, KLayoutItem* item,
	int32 index)
{
...
void
KTwoDimensionalLayout::LayoutInvalidated(bool children)
{
...
void
KTwoDimensionalLayout::DoLayout()
{
	_ValidateMinMax();
...
#ifdef DEBUG_LAYOUT
printf("KTwoDimensionalLayout::DerivedLayoutItems(): view: %p"
...
BSize
KTwoDimensionalLayout::AddInsets(BSize size)
{
...
void
KTwoDimensionalLayout::AddInsets(float* minHeight, float* maxHeight,
	float* preferredHeight)
{
...
BSize
KTwoDimensionalLayout::SubtractInsets(BSize size)
{
...
void
KTwoDimensionalLayout::PrepareItems(orientation orientation)
{
}


bool
KTwoDimensionalLayout::HasMultiColumnItems()
{
	return false;
}
...
bool
KTwoDimensionalLayout::HasMultiRowItems()
{
	return false;
}
...
void
KTwoDimensionalLayout::_ValidateMinMax()
{
...
KTwoDimensionalLayout::CompoundLayouter::CompoundLayouter(
	orientation orientation)
	:
	fLayouter(NULL),
	fLayoutInfo(NULL),
...
orientation
KTwoDimensionalLayout::CompoundLayouter::Orientation()
{
	return fOrientation;
}
...
Layouter*
KTwoDimensionalLayout::CompoundLayouter::GetLayouter(bool minMax)
{
	return fLayouter;
}
...
LayoutInfo*
KTwoDimensionalLayout::CompoundLayouter::GetLayoutInfo()
{
	return fLayoutInfo;
}
...
void
KTwoDimensionalLayout::CompoundLayouter::AddLocalLayouter(
	LocalLayouter* localLayouter)
{
	if (localLayouter) {
...
void
KTwoDimensionalLayout::CompoundLayouter::RemoveLocalLayouter(
	LocalLayouter* localLayouter)
{
...
status_t
KTwoDimensionalLayout::CompoundLayouter::AddAlignedLayoutsToArchive(
...
void
KTwoDimensionalLayout::CompoundLayouter::AbsorbCompoundLayouter(
...
void
KTwoDimensionalLayout::CompoundLayouter::InvalidateLayout()
{
	if (!fLayouter)
		return;
...
bool
KTwoDimensionalLayout::CompoundLayouter::IsMinMaxValid()
{
...
void
KTwoDimensionalLayout::CompoundLayouter::ValidateMinMax()
{
	if (IsMinMaxValid())
		return;
...
void
KTwoDimensionalLayout::CompoundLayouter::Layout(float size,
...
void
KTwoDimensionalLayout::CompoundLayouter::DoLayout(float size,
	LocalLayouter* localLayouter, BLayoutContext* context)
{
...
void
KTwoDimensionalLayout::CompoundLayouter::_PrepareItems()
{
	int32 count = fLocalLayouters.CountItems();
	for (int32 i = 0; i < count; i++) {
		LocalLayouter* layouter = (LocalLayouter*)fLocalLayouters.ItemAt(i);
...
int32
KTwoDimensionalLayout::CompoundLayouter::_CountElements()
{
...
bool
KTwoDimensionalLayout::CompoundLayouter::_HasMultiElementItems()
{
	int32 count = fLocalLayouters.CountItems();
	for (int32 i = 0; i < count; i++) {
		LocalLayouter* layouter = (LocalLayouter*)fLocalLayouters.ItemAt(i);
...
void
KTwoDimensionalLayout::CompoundLayouter::_AddConstraints(Layouter* layouter)
{
	int32 count = fLocalLayouters.CountItems();
	for (int32 i = 0; i < count; i++) {
...
float
KTwoDimensionalLayout::CompoundLayouter::_Spacing()
{
...
KTwoDimensionalLayout::VerticalCompoundLayouter::VerticalCompoundLayouter()
	:
...
Layouter*
KTwoDimensionalLayout::VerticalCompoundLayouter::GetLayouter(bool minMax)
{
...
void
KTwoDimensionalLayout::VerticalCompoundLayouter::InvalidateLayout()
{
...
void
KTwoDimensionalLayout::VerticalCompoundLayouter::InvalidateHeightForWidth()
{
...
void
KTwoDimensionalLayout::VerticalCompoundLayouter::InternalGetHeightForWidth(
...
void
KTwoDimensionalLayout::VerticalCompoundLayouter::DoLayout(float size,
	LocalLayouter* localLayouter, BLayoutContext* context)
{
	Layouter* layouter;
...
bool
KTwoDimensionalLayout::VerticalCompoundLayouter::_HasHeightForWidth()
{
	int32 count = fLocalLayouters.CountItems();
	for (int32 i = 0; i < count; i++) {
		LocalLayouter* layouter = (LocalLayouter*)fLocalLayouters.ItemAt(i);
...
bool
KTwoDimensionalLayout::VerticalCompoundLayouter
...
void
KTwoDimensionalLayout::VerticalCompoundLayouter::LayoutContextLeft(
	BLayoutContext* context)
{
	fHeightForWidthLayoutContext = NULL;
}
...
KTwoDimensionalLayout::LocalLayouter::LocalLayouter(
		KTwoDimensionalLayout* layout)
	:
	fLayout(layout),
...
BSize
KTwoDimensionalLayout::LocalLayouter::MinSize()
{
...
BSize
KTwoDimensionalLayout::LocalLayouter::MaxSize()
{
...
BSize
KTwoDimensionalLayout::LocalLayouter::PreferredSize()
{
...
void
KTwoDimensionalLayout::LocalLayouter::InvalidateLayout()
{
...
void
KTwoDimensionalLayout::LocalLayouter::Layout(BSize size)
{
...
BRect
KTwoDimensionalLayout::LocalLayouter::ItemFrame(Dimensions itemDimensions)
{
...
void
KTwoDimensionalLayout::LocalLayouter::ValidateMinMax()
{
...
void
KTwoDimensionalLayout::LocalLayouter::DoHorizontalLayout(float width)
{
...
void
KTwoDimensionalLayout::LocalLayouter::InternalGetHeightForWidth(float width,
	float* minHeight, float* maxHeight, float* preferredHeight)
{
...
void
KTwoDimensionalLayout::LocalLayouter::AlignWith(LocalLayouter* other,
	orientation orientation)
{
...
status_t
KTwoDimensionalLayout::LocalLayouter::AddAlignedLayoutsToArchive(
	BArchiver* archiver)
{
...
status_t
KTwoDimensionalLayout::LocalLayouter::AddOwnerToArchive(BArchiver* archiver,
...
status_t
KTwoDimensionalLayout::LocalLayouter::AlignLayoutsFromArchive(
	BUnarchiver* unarchiver, orientation posture)
{
	...
	KTwoDimensionalLayout* retriever;
...
void
KTwoDimensionalLayout::LocalLayouter::PrepareItems(
	CompoundLayouter* compoundLayouter)
{
...
int32
KTwoDimensionalLayout::LocalLayouter::CountElements(
	CompoundLayouter* compoundLayouter)
{
...
bool
KTwoDimensionalLayout::LocalLayouter::HasMultiElementItems(
	CompoundLayouter* compoundLayouter)
{
	if (compoundLayouter->Orientation() == B_HORIZONTAL)
...
void
KTwoDimensionalLayout::LocalLayouter::AddConstraints(
	CompoundLayouter* compoundLayouter, Layouter* layouter)
{
	...
	if (itemCount > 0) {
		for (int i = 0; i < itemCount; i++) {
			KLayoutItem* item = fLayout->ItemAt(i);
			if (item->IsVisible()) {
				Dimensions itemDimensions;
...
float
KTwoDimensionalLayout::LocalLayouter::Spacing(
	CompoundLayouter* compoundLayouter)
{
...
bool
KTwoDimensionalLayout::LocalLayouter::HasHeightForWidth()
{
...
bool
KTwoDimensionalLayout::LocalLayouter::AddHeightForWidthConstraints(
	...
	BLayoutContext* context)
{
	...
	for (int32 i = 0; i < itemCount; i++) {
		KLayoutItem* item = (KLayoutItem*)fHeightForWidthItems.ItemAt(i);
		Dimensions itemDimensions;
		fLayout->GetItemDimensions(item, &itemDimensions);
...
void
KTwoDimensionalLayout::LocalLayouter::SetHeightForWidthConstraintsAdded(
	bool added)
{
...
void
KTwoDimensionalLayout::LocalLayouter::SetCompoundLayouter(
...
void
KTwoDimensionalLayout::LocalLayouter::InternalInvalidateLayout(
	CompoundLayouter* compoundLayouter)
{
	_SetHorizontalLayoutContext(NULL, -1);

	fLayout->KLayout::InvalidateLayout();
}


void
KTwoDimensionalLayout::LocalLayouter::_SetHorizontalLayoutContext(
	BLayoutContext* context, float width)
{
	if (context != fHorizontalLayoutContext) {
...
void
KTwoDimensionalLayout::LocalLayouter::LayoutContextLeft(BLayoutContext* context)
{
	fHorizontalLayoutContext = NULL;
...
status_t
KTwoDimensionalLayout::Perform(perform_code code, void* _data)
{
	return KAbstractLayout::Perform(code, _data);
}


void KTwoDimensionalLayout::_ReservedTwoDimensionalLayout1() {}
void KTwoDimensionalLayout::_ReservedTwoDimensionalLayout2() {}
void KTwoDimensionalLayout::_ReservedTwoDimensionalLayout3() {}
void KTwoDimensionalLayout::_ReservedTwoDimensionalLayout4() {}
void KTwoDimensionalLayout::_ReservedTwoDimensionalLayout5() {}
void KTwoDimensionalLayout::_ReservedTwoDimensionalLayout6() {}
void KTwoDimensionalLayout::_ReservedTwoDimensionalLayout7() {}
void KTwoDimensionalLayout::_ReservedTwoDimensionalLayout8() {}
void KTwoDimensionalLayout::_ReservedTwoDimensionalLayout9() {}
void KTwoDimensionalLayout::_ReservedTwoDimensionalLayout10() {}
