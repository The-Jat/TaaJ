 ...
 */
#ifndef _K_SERVER_WINDOW_H
#define _K_SERVER_WINDOW_H
...
#define AS_UPDATE_DECORATOR_2 'asu2'
#define AS_UPDATE_COLORS_2 'asu2'
#define AS_UPDATE_FONTS_2 'asu2'


class KServerWindow : public MessageLooper {
public:
								KServerWindow(const char *title, ServerApp *app,
									port_id clientPort, port_id looperPort,
									int32 clientToken);
	virtual						~KServerWindow();
...
private:
			K_View*				_CreateView(BPrivate::LinkReceiver &link,
									K_View **_parent);
	...
	virtual void				_GetLooperName(char* name, size_t size);
			...
			void				_SetCurrentView(K_View* view);
			void				_UpdateDrawState(K_View* view);
...
public:
bool IsKWindow;//to Identify whether called from KWindow 
};
