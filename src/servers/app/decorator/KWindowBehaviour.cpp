...
K_WindowBehaviour::K_WindowBehaviour()
	:
	fIsResizing(false),
	fIsDragging(false)
{
...
void
K_WindowBehaviour::ModifiersChanged(int32 modifiers)
{
}


bool
K_WindowBehaviour::AlterDeltaForSnap(K_Window* window, BPoint& delta, bigtime_t now)
{
	return false;
}


/*!	\fn K_WindowBehaviour::MouseDown()
	...
	\return \c true, if the event was a K_WindowBehaviour event and should be
		discarded.
*/
