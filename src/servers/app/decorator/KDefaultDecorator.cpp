...
{
debug_printf("[K_DefaultDecorator]{ K_DefaultDecorator}...\n");
	// TODO: If the decorator was created with a frame too small, it should
	// resize itself!

	STRACE(("K_DefaultDecorator:\n"));
	STRACE(("\tFrame (%.1f,%.1f,%.1f,%.1f)\n",
		rect.left, rect.top, rect.right, rect.bottom));
	debug_printf("\tK_DefaultDecorator Frame (%.1f,%.1f,%.1f,%.1f)\n",
		rect.left, rect.top, rect.right, rect.bottom);
}


K_DefaultDecorator::~K_DefaultDecorator()
{
	STRACE(("K_DefaultDecorator: ~K_DefaultDecorator()\n"));
}
...
*/
void
K_DefaultDecorator::GetComponentColors(Component component, uint8 highlight,
	ComponentColors _colors, K_Decorator::Tab* _tab)
{
debug_printf("[K_DefaultDecorator] {GetComponentColors}\n");
...
void
K_DefaultDecorator::_DrawFrame(BRect rect)
{
	STRACE(("_DrawFrame(%f,%f,%f,%f)\n", rect.left, rect.top,
		rect.right, rect.bottom));
		
	debug_printf("K_DefaultDecorator _DrawFrame(%f,%f,%f,%f)\n", rect.left, rect.top,
		rect.right, rect.bottom);
...
#define COLORS_INDEX(i, borderWidth, nominalLimit) int32((float(i) / float(borderWidth)) * nominalLimit)
	...
	debug_printf("K_DefaultDecorator _DrawFrame border (%f,%f,%f,%f)\n", border.left, border.top,
...
void
K_DefaultDecorator::_DrawResizeKnob(BRect rect, bool full,
...
*/
void
K_DefaultDecorator::_DrawTitle(K_Decorator::Tab* _tab, BRect rect)
{
...
*/
void
K_DefaultDecorator::_DrawClose(K_Decorator::Tab* _tab, bool direct, BRect rect)
{
...
*/
void
K_DefaultDecorator::_DrawZoom(K_Decorator::Tab* _tab, bool direct, BRect rect)
{
...
void
K_DefaultDecorator::_DrawMinimize(K_Decorator::Tab* tab, bool direct, BRect rect)
{
...
void
K_DefaultDecorator::_DrawButtonBitmap(ServerBitmap* bitmap, bool direct,
	BRect rect)
{
	if (bitmap == NULL)
		return;
...
*/
void
K_DefaultDecorator::_DrawBlendedRect(DrawingEngine* engine, const BRect rect,
...
ServerBitmap*
K_DefaultDecorator::_GetBitmapForButton(K_Decorator::Tab* tab, Component item,
	bool down, int32 width, int32 height)
{
	...
	STRACE(("K_DefaultDecorator creating bitmap for %s %s at size %ldx%ld\n",
...
void
K_DefaultDecorator::_GetComponentColors(Component component,
	ComponentColors _colors, K_Decorator::Tab* tab)
{
