 ...
 */
#ifndef K_TAB_DECORATOR_H
#define K_TAB_DECORATOR_H
...
protected:
	...
	virtual	void				_DrawTab(K_Decorator::Tab* tab, BRect r) = 0;

	virtual	void				_DrawButtons(K_Decorator::Tab* tab,
									const BRect& invalid);
	virtual	void				_DrawClose(K_Decorator::Tab* tab, bool direct,
									BRect r) = 0;
	virtual	void				_DrawTitle(K_Decorator::Tab* tab, BRect r) = 0;
