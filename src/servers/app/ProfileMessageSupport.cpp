...
// Desktop definitions (through the ServerApp, though)
		CODE(AS_GET_WINDOW_LIST_2);
		CODE(AS_GET_WINDOW_INFO_2);
		CODE(AS_MINIMIZE_TEAM_2);
		CODE(AS_BRING_TEAM_TO_FRONT_2);
		CODE(AS_WINDOW_ACTION_2);

CODE(AS_GET_SCREEN_ID_FROM_WINDOW_2);

//CODE(AS_MINIMIZE_TEAM_2);

CODE(AS_KHIDKI_KHOL);
CODE(AS_CREATE_OFFSCREEN_WINDOW_2);

CODE(AS_VIEW_CREATE_2);
CODE(AS_CREATE_LAMINATE_JADD);
CODE(AS_VIEW_SHOW_2);
CODE(AS_VIEW_HIDE_2);
CODE(AS_VIEW_MOVE_2);
CODE(AS_VIEW_RESIZE_2);
CODE(AS_VIEW_DRAW_2);

CODE(AS_SET_CURRENT_VIEW_2);

CODE(AS_VIEW_SET_STATE_2);
CODE(AS_VIEW_GET_STATE_2);

// Global function call defs
CODE(AS_SET_UI_COLORS_2);
CODE(AS_SET_UI_COLOR_2);
CODE(AS_SET_DECORATOR_2);
CODE(AS_GET_DECORATOR_2);
//end
