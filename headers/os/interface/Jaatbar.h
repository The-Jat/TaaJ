...
public:
	...
	// Location methods
			BRect				Frame() const;
			k_deskbar_location	Location(bool* _isExpanded = NULL) const;
			status_t			SetLocation(k_deskbar_location location,
									bool expanded = false);
	...
	// Item modification methods
			status_t			AddItem(KView* archivableView,
									int32* _id = NULL);
