 ...
 */
#ifndef	_K_LAYOUT_ITEM_H
#define	_K_LAYOUT_ITEM_H
...
class KLayoutItem : public BArchivable {
public:
								KLayoutItem();
								KLayoutItem(BMessage* from);
	virtual						~KLayoutItem();

			KLayout*			Layout() const;
			bool				RemoveSelf();
...
private:
	...
	// forbidden methods
								KLayoutItem(const KLayoutItem&);
			void				operator =(const KLayoutItem&);
