 ...
 */
#ifndef	_K_ABSTRACT_LAYOUT_ITEM_H
#define	_K_ABSTRACT_LAYOUT_ITEM_H
...
class KAbstractLayoutItem : public KLayoutItem {
public:
								KAbstractLayoutItem();
								KAbstractLayoutItem(BMessage* from);
	virtual						~KAbstractLayoutItem();
...
private:
	...
	// forbidden methods
								KAbstractLayoutItem(const KAbstractLayoutItem&);
			void				operator =(const KAbstractLayoutItem&);
