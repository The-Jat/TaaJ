 ...
 */
#ifndef _K_CONTROL_LOOK_H
#define _K_CONTROL_LOOK_H
...
public:
	...
	virtual uint32				Flags(KControl* control) const = 0;
	...
	virtual	void				DrawLabel(KView* view, const char* label,
			...
			void				DrawLabel(KView* view, const char* label,
...
extern KControlLook* k_be_control_look;

extern "C" _EXPORT KControlLook *k_instantiate_control_look(image_id id);


} // namespace BPrivate

using BPrivate::KControlLook;
using BPrivate::k_be_control_look;
