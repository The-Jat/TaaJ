...
enum k_hash_mark_location {
	K_HASH_MARKS_NONE = 0,
	K_HASH_MARKS_TOP = 1,
	K_HASH_MARKS_LEFT = 1,
	K_HASH_MARKS_BOTTOM = 2,
	K_HASH_MARKS_RIGHT = 2,
	K_HASH_MARKS_BOTH = 3
};
...
class KSlider : public KControl {
public:
								KSlider(BRect frame, const char* name,
									const char* label, BMessage* message,
									int32 minValue, int32 maxValue,
									k_thumb_style thumbType = K_BLOCK_THUMB,
								...
								KSlider(const char* name, const char* label,
	...
	virtual	void				SetHashMarks(k_hash_mark_location where);
			k_hash_mark_location	HashMarks() const;

	virtual	void				SetStyle(k_thumb_style style);
			k_thumb_style			Style() const;
...
private:
	...
	virtual	void				_ReservedSlider12();
			...
			KSlider&			operator=(const KSlider& other);
...
private:
			...
			k_hash_mark_location 	fHashMarks;

			KBitmap*			fOffScreenBits;
			KView*				fOffScreenView;

			k_thumb_style			fStyle;
