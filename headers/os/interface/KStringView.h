 ...
 */
#ifndef K__STRING_VIEW_H
#define K__STRING_VIEW_H


#include <Laminate.h>


class KStringView : public KView {
public:
								KStringView(BRect frame, const char* name,
									const char* text, uint32 resizingMode
										= B_FOLLOW_LEFT_TOP,
									uint32 flags = B_WILL_DRAW);
								KStringView(const char* name, const char* text,
									uint32 flags = B_WILL_DRAW);
								KStringView(BMessage* archive);
	virtual 					~KStringView();
