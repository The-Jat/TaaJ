 ...
 */
#ifndef _K_MENU_FIELD_H
#define _K_MENU_FIELD_H
...
class KMenuField : public KView {
public:
								KMenuField(BRect frame, const char* name,
									const char* label, KMenu* menu,
								...
								KMenuField(BRect frame, const char* name,
									...
									uint32 resizingMode = B_FOLLOW_LEFT_TOP,
									uint32 flags = B_WILL_DRAW | B_NAVIGABLE);
								KMenuField(const char* name,
									const char* label, KMenu* menu,
									uint32 flags = B_WILL_DRAW | B_NAVIGABLE);
								KMenuField(const char* label, KMenu* menu,
									uint32 flags = B_WILL_DRAW | B_NAVIGABLE);
								KMenuField(BMessage* data);
	virtual						~KMenuField();
	...
	virtual	BSize				PreferredSize();
			...
			KLayoutItem*		CreateMenuBarLayoutItem();
...
private:
	...
	// Forbidden
			KMenuField&			operator=(const KMenuField& other);
...
private:
	...
	friend struct LayoutData;
								...
								KMenuField(const char* name,
									...
									BMessage* message,
									uint32 flags);
								KMenuField(const char* label,
									KMenu* menu, BMessage* message);
